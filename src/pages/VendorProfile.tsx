    ...
    const fetchVendor = async () => {
      ...
      try {
        ...
        const [
          ...
          (supabase.from("vendor_deals") as any).select("*").eq("vendor_id", id).eq("is_active", true).lte("starts_at", new Date().toISOString()).gt("expires_at", new Date().toISOString()).order("expires_at", { ascending: true }),
