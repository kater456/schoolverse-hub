...
const ALL_Q = [
  ...
  // ── SECTION 5: CARDIAC MUSCLE, SMOOTH MUSCLE & ANS ─────────────────────────
  {id:161,s:1,t:"Cardiac Muscle",q:"What is the primary pacemaker of the heart?",o:["Atrioventricular node","Bundle of His","Sinoatrial node","Purkinje fibers","Left atrium"],a:2},
  {id:162,s:1,t:"Cardiac Muscle",q:"Which of the following characterizes the absolute refractory period of cardiac muscle?",o:["It is very short compared to skeletal muscle","It prevents tetanic contractions","It occurs during diastole only","It is caused by rapid potassium efflux","It allows for summation of contractions"],a:1},
  {id:163,s:1,t:"Cardiac Muscle",q:"What is the role of calcium in cardiac muscle contraction?",o:["Binds to troponin C to allow cross-bridge formation","Inhibits myosin ATPase","Promotes sodium efflux","Prevents repolarization","Binds to tropomyosin directly"],a:0},
  {id:164,s:1,t:"Cardiac Muscle",q:"The plateau phase of the cardiac action potential is primarily due to:",o:["Rapid sodium influx","Opening of L-type calcium channels","Closing of potassium channels","Inward movement of chloride ions","Opening of T-type calcium channels"],a:1},
  {id:165,s:1,t:"Cardiac Muscle",q:"What is the Frank-Starling law of the heart?",o:["Heart rate increases with exercise","Stroke volume increases in response to an increase in volume of blood in the ventricles","Blood pressure is inversely proportional to heart rate","The heart always pumps the same amount of blood","Cardiac output is determined solely by heart rate"],a:1},
  {id:166,s:1,t:"Smooth Muscle",q:"Which protein binds calcium in smooth muscle to initiate contraction?",o:["Troponin C","Calmodulin","Myosin light chain kinase","Actin","Tropomyosin"],a:1},
  {id:167,s:1,t:"Smooth Muscle",q:"Multi-unit smooth muscle is found in:",o:["Walls of the gastrointestinal tract","Uterus","Arteries","Iris of the eye","Urinary bladder"],a:3},
  {id:168,s:1,t:"Smooth Muscle",q:"Unitary (single-unit) smooth muscle cells are connected by:",o:["Desmosomes","Tight junctions","Gap junctions","Synapses","None of the above"],a:2},
  {id:169,s:1,t:"Smooth Muscle",q:"Smooth muscle contraction is different from skeletal muscle because it:",o:["Does not use actin and myosin","Is always under voluntary control","Can maintain contraction for long periods with little energy (latch state)","Uses troponin for regulation","Does not require calcium"],a:2},
  {id:170,s:1,t:"Autonomic Nervous System",q:"The sympathetic nervous system generally:",o:["Slows heart rate","Increases gastrointestinal motility","Promotes 'fight or flight' responses","Causes pupillary constriction","Stimulates bladder contraction"],a:2},
  {id:171,s:1,t:"Autonomic Nervous System",q:"Parasympathetic preganglionic neurons release:",o:["Norepinephrine","Epinephrine","Acetylcholine","Dopamine","Serotonin"],a:2},
  {id:172,s:1,t:"Autonomic Nervous System",q:"Which receptor is found on the target organs of the parasympathetic nervous system?",o:["Nicotinic","Alpha-1 adrenergic","Beta-1 adrenergic","Muscarinic","Beta-2 adrenergic"],a:3},
