...
const vendorSchema = z.object({
  ...
  academic_level: z.string().min(1, "Level is required"),
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <FormField control={form.control} name="academic_level" render={({ field }) => (
                    <FormItem><FormLabel>Academic Level</FormLabel>
                      <Select onValueChange={field.onChange} value={field.value}>
                        <FormControl><SelectTrigger><SelectValue placeholder="Select level" /></SelectTrigger></FormControl>
                        <SelectContent>
                          {["100L", "200L", "300L", "400L", "500L", "600L", "Graduate/Alumni"].map((lvl) => (
                  ...
                  <FormField control={form.control} name="department" render={({ field }) => (
                    <FormItem><FormLabel>Department</FormLabel>
                      <FormControl><Input placeholder="e.g. Medicine, Computer Science" {...field} /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
                  ...
                  <div>
                    ...
                    <div className="mt-2">
                      <label className="flex items-center justify-center gap-2 border-2 border-dashed border-border rounded-lg p-4 cursor-pointer hover:border-accent transition-colors">
                        ...
                        <span className="text-sm text-muted-foreground">{vendorPhoto ? vendorPhoto.name : "Upload your photo"}</span>
